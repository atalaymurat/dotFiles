...
#list
alias ls='exa --all --grid --group-directories-first'
alias la='exa --all -l --group-directories-first'
alias ll='ls -la'
alias l='ls'
alias l.="ls -A | egrep '^\.'"
...
alias config='/usr/bin/git --git-dir=/home/atalaymurat/dotFiles/ --work-tree=/home/atalaymurat'
